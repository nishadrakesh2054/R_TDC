...
import { sendRegistrationEmail } from "./TDCemailService.js";
import * as TDCPDFAttachments from "./TDCexportDownloadablepdf.js";
...
export const sendRegistrationSuccessEmail = async ({ locals }, res) => {
  ...
  try {
    const selectedGame = await TDCGame.findByPk(participation.gameId);
    ...
    if (!attachment) {
      ...
      attachment = TDCPDFAttachments.TDCINVITATION;
    }
